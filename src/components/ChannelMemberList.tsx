...
const ChannelMemberList = ({ users, isOpen }: Props) => {
	return (
		<div
			className={` ${isOpen ? "w-62" : "w-0"}   border-l border-neutral-800 flex flex-col flex-none overflow-y-auto overflow-x-hidden transition-all duration-300 scroll-stable`}
		>
